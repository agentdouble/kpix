...
- `src/pages` : écrans du parcours manager (dont la page détail KPI avec un graphique d'évolution interactif qui met en évidence les périodes avec actions/commentaires).
